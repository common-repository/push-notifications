...
class Pushwoosh {
	...
	public function createMessage($applicationCode, $messageContent, $options = array()) {
		$body = array(
	...
	public function createTargetedMessage($applicationCode, $messageContent, $options = array()) {
		$body = array(
			'auth' => $this->settings['auth'],
			'send_date' => 'now',
			'content' => array(
