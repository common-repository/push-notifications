		...
		'application_access' => array(
			...
			'fields' => array(
				...
				'chrome_default_icon' => array(
					'label' => 'Chrome/Firefox Icon',
					'description' => 'Full URL to icon',
				),
				'safari_title' => array(
					'label' => 'Title',
					'description' => 'If you do not wish to manually input Chrome/Firefox/Safari Title every time, you can specify
					the default title here. If you publish a post with a blank Chrome/Firefox/Safari Title field,
...
class PushwooshSectionHelper {
	...
	public function input_submit($value) {
		echo sprintf('<input type="submit" name="Submit" class="button button-primary" value="%s" />', $value);
	}
